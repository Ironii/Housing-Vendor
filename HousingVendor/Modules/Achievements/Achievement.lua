...
local function FetchAchievementData(achievementID)
    ...
    -- Use C_AchievementInfo API (safer than deprecated GetAchievementInfo)
    local success, id, name, points, completed, month, day, year, description, flags, icon, rewardText, isGuild, wasEarnedByMe, earnedBy = pcall(function()
